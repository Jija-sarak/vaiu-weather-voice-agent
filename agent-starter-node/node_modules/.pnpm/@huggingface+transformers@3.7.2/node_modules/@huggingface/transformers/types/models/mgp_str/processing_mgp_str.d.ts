export class MgpstrProcessor extends Processor {
     ...
     */
    get char_tokenizer(): import("../../../src/tokenizers.js").MgpstrTokenizer;
    /**
     * @returns {import('../../tokenizers.js').GPT2Tokenizer} The BPE tokenizer.
     */
    get bpe_tokenizer(): import("../../../src/tokenizers.js").GPT2Tokenizer;
    /**
     * @returns {import('../../tokenizers.js').BertTokenizer} The WordPiece tokenizer.
     */
    get wp_tokenizer(): import("../../../src/tokenizers.js").BertTokenizer;
    /**
     ...
     */
    _decode_helper(pred_logits: import("../../../src/utils/tensor.js").Tensor, format: string): [string[], number[]];
    /**
     ...
     */
    batch_decode([char_logits, bpe_logits, wp_logits]: import("../../../src/utils/tensor.js").Tensor[]): {
...
import { AutoImageProcessor } from "../../../src/models/auto/image_processing_auto.js";
