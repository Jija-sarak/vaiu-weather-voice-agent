...
export type ProgressCallback = import("../src/utils/core.js").ProgressCallback;
export type ProgressInfo = import("../src/utils/core.js").ProgressInfo;
/**
...
export type TransformersJSConfig = {
     ...
     */
    device_config?: Record<import("../src/utils/devices.js").DeviceType, DeviceConfig>;
    /**
     * The data type of the key-value cache.
     */
    kv_cache_dtype?: import("../src/utils/tensor.js").DataType | Record<import("../src/utils/dtypes.js").DataType, import("../src/utils/tensor.js").DataType>;
    /**
     ...
     */
    device?: import("../src/utils/devices.js").DeviceType;
    /**
     * The default data type to use for the model.
     */
    dtype?: import("../src/utils/dtypes.js").DataType | Record<string, import("../src/utils/dtypes.js").DataType>;
    /**
     * Whether to load the model using the external data format (used for models >= 2GB in size).
     */
    use_external_data_format?: import("../src/utils/hub.js").ExternalData | Record<string, import("../src/utils/hub.js").ExternalData>;
};
/**
