...
export class GroundingDinoImageProcessor extends ImageProcessor {
     ...
     */
    _call(images: import("../../../src/utils/image.js").RawImage[]): Promise<GroundingDinoFeatureExtractorResult>;
}
export type GroundingDinoFeatureExtractorResultProps = {
    pixel_mask: import("../../../src/utils/tensor.js").Tensor;
};
export type GroundingDinoFeatureExtractorResult = import("../../../src/base/image_processors_utils.js").ImageProcessorResult & GroundingDinoFeatureExtractorResultProps;
