export class PyAnnoteFeatureExtractor extends FeatureExtractor {
     ...
     */
    post_process_speaker_diarization(logits: import("../../../src/utils/tensor.js").Tensor, num_samples: number): Array<Array<{
        id: number;
        start: number;
        end: number;
        confidence: number;
...
import { FeatureExtractor } from '../../../src/base/feature_extraction_utils.js';
