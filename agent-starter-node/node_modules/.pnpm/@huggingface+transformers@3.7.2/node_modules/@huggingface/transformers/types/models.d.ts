...
export class PreTrainedModel extends PreTrainedModel_base {
     ...
     */
    static from_pretrained(pretrained_model_name_or_path: string, { progress_callback, config, cache_dir, local_files_only, revision, model_file_name, subfolder, device, dtype, use_external_data_format, session_options, }?: import("../src/utils/hub.js").PretrainedModelOptions): Promise<PreTrainedModel>;
    /**
     ...
     */
    constructor(config: import("../src/configs.js").PretrainedConfig, sessions: Record<string, any>, configs: Record<string, any>);
    main_input_name: string;
    forward_params: string[];
    config: import("../src/configs.js").PretrainedConfig;
    ...
    custom_config: import("../src/configs.js").TransformersJSConfig;
    /**
    ...
    */
     ...
     */
    generate({ inputs, generation_config, logits_processor, stopping_criteria, streamer, ...kwargs }: import("../src/generation/parameters.js").GenerationFunctionParameters): Promise<ModelOutput | Tensor>;
    /**
...
export class WhisperForConditionalGeneration extends WhisperPreTrainedModel {
     ...
     * @returns {Promise<ModelOutput|Tensor>} The output of the model, which can contain the generated token ids, attentions, and scores.
     */
    generate({ inputs, generation_config, logits_processor, stopping_criteria, ...kwargs }: import("../src/models/whisper/generation_whisper.js").WhisperGenerationFunctionParameters): Promise<ModelOutput | Tensor>;
    /**
...
export class MultiModalityCausalLM extends MultiModalityPreTrainedModel {
     ...
     * @param {import('./generation/parameters.js').GenerationFunctionParameters} options
     */
    generate_images(options: import("../src/generation/parameters.js").GenerationFunctionParameters): Promise<RawImage[]>;
}
...
import { LogitsProcessorList } from '../src/generation/logits_process.js';
import { StoppingCriteriaList } from '../src/generation/stopping_criteria.js';
import { Tensor } from '../src/utils/tensor.js';
import { WhisperGenerationConfig } from '../src/models/whisper/generation_whisper.js';
