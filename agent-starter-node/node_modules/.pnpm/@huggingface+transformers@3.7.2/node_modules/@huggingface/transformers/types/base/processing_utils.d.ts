...
export class Processor extends Processor_base {
     ...
     */
    get image_processor(): import("../../src/base/image_processors_utils.js").ImageProcessor | undefined;
    /**
     ...
     */
    get feature_extractor(): import("../../src/base/feature_extraction_utils.js").FeatureExtractor | undefined;
    /**
     ...
     */
    batch_decode(batch: number[][] | import("../../src/transformers.js").Tensor, decode_args?: any): ReturnType<PreTrainedTokenizer["batch_decode"]>;
    /**
     * @param {Parameters<PreTrainedTokenizer['decode']>} args
     * @returns {ReturnType<PreTrainedTokenizer['decode']>}
     */
    decode(token_ids: number[] | bigint[] | import("../../src/transformers.js").Tensor, decode_args?: {
...
export type PretrainedProcessorOptions = import("../../src/utils/hub.js").PretrainedOptions & ProcessorProperties;
export type PreTrainedTokenizer = import("../../src/tokenizers.js").PreTrainedTokenizer;
export {};
