 ...
 */
export function pipeline<T extends PipelineType>(task: T, model?: string, { progress_callback, config, cache_dir, local_files_only, revision, device, dtype, subfolder, use_external_data_format, model_file_name, session_options, }?: import("../src/utils/hub.js").PretrainedModelOptions): Promise<AllTasks[T]>;
...
export class Text2TextGenerationPipeline extends Text2TextGenerationPipeline_base {
    /** @type {'generated_text'} */
    _key: "generated_text";
    _call(texts: string | string[], options?: Partial<import("../src/generation/configuration_utils.js").GenerationConfig>): Promise<Text2TextGenerationOutput | Text2TextGenerationOutput[]>;
}
...
export class ImageToTextPipeline extends ImageToTextPipeline_base {
    _call(texts: ImagePipelineInputs, options?: Partial<import("../src/generation/configuration_utils.js").GenerationConfig>): Promise<ImageToTextOutput | ImageToTextOutput[]>;
}
...
export class DocumentQuestionAnsweringPipeline extends DocumentQuestionAnsweringPipeline_base {
    _call(image: ImageInput, question: string, options?: Partial<import("../src/generation/configuration_utils.js").GenerationConfig>): Promise<DocumentQuestionAnsweringOutput | DocumentQuestionAnsweringOutput[]>;
}
 ...
 */
export type Text2TextGenerationPipelineCallback = (texts: string | string[], options?: Partial<import("../src/generation/configuration_utils.js").GenerationConfig>) => Promise<Text2TextGenerationOutput | Text2TextGenerationOutput[]>;
 ...
 */
export type SummarizationPipelineCallback = (texts: string | string[], options?: import("../src/generation/configuration_utils.js").GenerationConfig) => Promise<SummarizationOutput | SummarizationOutput[]>;
 ...
 */
export type TranslationPipelineCallback = (texts: string | string[], options?: import("../src/generation/configuration_utils.js").GenerationConfig) => Promise<TranslationOutput | TranslationOutput[]>;
export type TranslationPipelineType = TextPipelineConstructorArgs & TranslationPipelineCallback & Disposable;
export type Chat = import("../src/tokenizers.js").Message[];
...
export type TextGenerationConfig = import("../src/generation/configuration_utils.js").GenerationConfig & TextGenerationSpecificParams;
/**
...
export type AutomaticSpeechRecognitionConfig = import("../src/generation/configuration_utils.js").GenerationConfig & AutomaticSpeechRecognitionSpecificParams;
/**
 ...
 */
export type ImageToTextPipelineCallback = (texts: ImagePipelineInputs, options?: Partial<import("../src/generation/configuration_utils.js").GenerationConfig>) => Promise<ImageToTextOutput | ImageToTextOutput[]>;
 ...
 */
export type DocumentQuestionAnsweringPipelineCallback = (image: ImageInput, question: string, options?: Partial<import("../src/generation/configuration_utils.js").GenerationConfig>) => Promise<DocumentQuestionAnsweringOutput | DocumentQuestionAnsweringOutput[]>;
...
import { Processor } from '../src/base/processing_utils.js';
