...
export class SamImageProcessor extends ImageProcessor {
     ...
     * @returns {Tensor}
     */
    reshape_input_points(input_points: any, original_sizes: import("../../../src/base/image_processors_utils.js").HeightWidth[], reshaped_input_sizes: import("../../../src/base/image_processors_utils.js").HeightWidth[], is_bounding_box?: boolean): Tensor;
    /**
     *
     ...
     */
    generate_crop_boxes(image: import("../../../src/utils/image.js").RawImage, target_size: number, { crop_n_layers, overlap_ratio, points_per_crop, crop_n_points_downscale_factor, }?: {
...
export type SamImageProcessorResult = {
    pixel_values: Tensor;
    original_sizes: import("../../../src/base/image_processors_utils.js").HeightWidth[];
    reshaped_input_sizes: import("../../../src/base/image_processors_utils.js").HeightWidth[];
    input_points?: Tensor;
    input_labels?: Tensor;
    input_boxes?: Tensor;
};
import { ImageProcessor } from "../../../src/base/image_processors_utils.js";
