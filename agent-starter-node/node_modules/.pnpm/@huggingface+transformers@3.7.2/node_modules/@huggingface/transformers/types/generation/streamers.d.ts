...
export class TextStreamer extends BaseStreamer {
     ...
     */
    constructor(tokenizer: import("../../src/tokenizers.js").PreTrainedTokenizer, { skip_prompt, callback_function, token_callback_function, skip_special_tokens, decode_kwargs, ...kwargs }?: {
        skip_prompt?: boolean;
    ...
    tokenizer: import("../../src/tokenizers.js").PreTrainedTokenizer;
    skip_prompt: boolean;
...
export class WhisperTextStreamer extends TextStreamer {
     ...
     * @param {Object} [options.decode_kwargs={}] Additional keyword arguments to pass to the tokenizer's decode method
     */
    constructor(tokenizer: import("../../src/tokenizers.js").WhisperTokenizer, { skip_prompt, callback_function, token_callback_function, on_chunk_start, on_chunk_end, on_finalize, time_precision, skip_special_tokens, decode_kwargs, }?: {
        skip_prompt?: boolean;
        callback_function?: (arg0: string) => void;
        token_callback_function?: (arg0: bigint[]) => void;
