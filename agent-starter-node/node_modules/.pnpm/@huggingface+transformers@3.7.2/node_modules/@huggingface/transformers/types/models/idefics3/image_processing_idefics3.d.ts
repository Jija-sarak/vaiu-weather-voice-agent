export class Idefics3ImageProcessor extends ImageProcessor {
     ...
     */
    get_resize_for_vision_encoder(pixel_values: import("../../../src/utils/tensor.js").Tensor, vision_encoder_max_size: number): {
        height: number;
        width: number;
    };
    /** @param {RawImage|RawImage[]|RawImage[][]} images */
    _call(images: import("../../../src/utils/image.js").RawImage | import("../../../src/utils/image.js").RawImage[] | import("../../../src/utils/image.js").RawImage[][], { do_image_splitting, return_row_col_info, }?: {
        do_image_splitting?: any;
        return_row_col_info?: boolean;
    }): Promise<{
        rows?: any[][];
        cols?: any[][];
        pixel_values: import("../../../src/utils/tensor.js").Tensor;
        pixel_attention_mask: import("../../../src/utils/tensor.js").Tensor;
