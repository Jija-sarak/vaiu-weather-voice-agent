...
import { type LLMModels, type STTModelString, type TTSModelString } from '../../src/inference/index.js';
import { ChatContext, ChatMessage } from '../../src/llm/chat_context.js';
import type { LLM, RealtimeModel, RealtimeModelError, ToolChoice } from '../../src/llm/index.js';
import type { LLMError } from '../../src/llm/llm.js';
import type { STT } from '../../src/stt/index.js';
import type { STTError } from '../../src/stt/stt.js';
import type { TTS, TTSError } from '../../src/tts/tts.js';
import type { VAD } from '../../src/vad.js';
import type { Agent } from '../../src/voice/agent.js';
import type { _TurnDetector } from '../../src/voice/audio_recognition.js';
...
import { AgentInput, AgentOutput } from '../../src/voice/io.js';
import { type RoomInputOptions, type RoomOutputOptions } from '../../src/voice/room_io/index.js';
import type { UnknownUserData } from '../../src/voice/run_context.js';
import type { SpeechHandle } from '../../src/voice/speech_handle.js';
...
export declare class AgentSession<UserData = UnknownUserData> extends AgentSession_base {
    ...
    interrupt(): import("../../src/utils.js").Future<void>;
