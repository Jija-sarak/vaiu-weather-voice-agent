...
import { type ProviderFormat } from '../../src/llm/provider_format/index.js';
import type { JSONObject, JSONValue, ToolContext } from '../../src/llm/tool_context.js';
...
export declare class ChatContext {
    ...
    toProviderFormat(format: ProviderFormat, injectDummyUserMessage?: boolean): Promise<[Record<string, unknown>[], import("../../src/llm/provider_format/google.js").GoogleFormatData] | Record<string, any>[]>;
    /**
