...
import type { ReadableLogRecord } from '.pnpm/@opentelemetry+sdk-logs@0.54.2_@opentelemetry+api@1.9.0/node_modules/@opentelemetry/sdk-logs/build/src/export/ReadableLogRecord';
import { AnyValue, LogAttributes, LogBody } from '@opentelemetry/api-logs';
import { LoggerProviderSharedState } from '.pnpm/@opentelemetry+sdk-logs@0.54.2_@opentelemetry+api@1.9.0/node_modules/@opentelemetry/sdk-logs/build/src/internal/LoggerProviderSharedState';
